/* @ts-self-types="./pdfmuse_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function parse(data, fmt) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(fmt) ? 0 : passStringToWasm0(fmt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pdfmuse_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
